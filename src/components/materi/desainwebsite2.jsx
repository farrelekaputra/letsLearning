         ...
         <section>
                    <LogicMateri
                        penjelasanMateri={{
                            ...
                            { tipe: 'gambar', width:'md:w-3/4', url:gambarwarna, caption:'contoh pemilihan warna' },
                            ...
                            { tipe: 'gambar', width:'md:w-3/4', url:gambarfont, caption:'contoh jenis huruf' },
                            ...
                            { tipe: 'gambar', width:'md:w-3/4', url:gambarlayout, caption:'contoh desain website layout yang baik' },
                            ]
                        }}
                        />
                        <Contohsoal
