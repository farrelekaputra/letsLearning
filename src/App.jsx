            ...
            <section>
              <div className="kontenAtas h-screen flex flex-col justify-evenly">
                <div className="nonWave-section md:h-3/4 gap-12 md:gap-0 p-12 md:p-20 flex flex-col-reverse md:flex-row mx-auto items-center">
                  <div className="text text-gray-800 flex flex-col gap-4">
                    <h1 className='text-5xl text-orange-500 font-semibold'>Let's Learning</h1>
                    <p className='md:w-3/4 text-justify'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa, perspiciatis provident! Quae velit molestias assumenda ipsam! Quod et non sapiente adipisci aspernatur minus doloribus. Hic necessitatibus sunt placeat praesentium vitae?</p>
                    <button onClick={scrollToLanding} className='p-2 rounded-lg bg-orange-500 text-white font-semibold hover:bg-orange-400 w-2/5'>Ayo Mulai!</button>
                  </div>
                  <img src={landingImage} className='w-4/5 md:w-1/3' alt="gambat thumbnail" />
                </div>
                <div className="wave-section h-1/4 -mt-12 md:-mt-40">
