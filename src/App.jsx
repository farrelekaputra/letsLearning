...
function App() {
  ...
  return (
    <>
      <Helmet>
        <title>Lets Learning</title>
        <meta property="og:title" content="Materi Belajar" />
        <meta property="og:url" content="https://lets-learning.vercel.app" />
      </Helmet>
      <Router>
        <Routes>
          {/* Halaman landing */}
            ...
            element={
              <section>
                <div className="kontenAtas h-screen flex flex-col justify-evenly">
                  ...
                  <div className="wave-section md:h-1/4 hidden md:block">
                    <svg xmlns="http://www.w3.org/2000/svg" className='scale-y-48' viewBox="0 0 1440 320">
                ...
                <div ref={landingRef}>
                  <Landing
                    listActivity={[
                      {
                        link: "/daftarMateri",
                        gambar: "https://api.iconify.design/fluent-color:calendar-sync-16.svg",
                        keterangan: "Lanjutkan Belajar",
                      },
                      {
                        link: "/listSoal",
                        gambar: "https://api.iconify.design/fluent-color:book-open-lightbulb-20.svg",
